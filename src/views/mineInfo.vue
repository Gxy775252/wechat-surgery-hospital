	...
	<div>
		...
		<div class="list" style="margin-top: calc(8.64rem / 2);">
			...
			<div @click="openPicker('picker')" class="list-right">
				<p :class="birthday=='选择生日'?'':'coloeAA'" ref="birthday">{{birthday}}</p>
				<div class="selectDiv">
		...
		<div class="list">
			...
			<div @click="PickerShow" class="list-right">
				<p :class="address.length!=0?'coloeAA':''" ref="address">{{address | pickerValueFilter}}</p>
				<div class="selectDiv">
					<img src="@/assets/images/icon/mineHore.png" />
				</div>
			</div>
		...
		<div class="list">
			...
			<div class="list-right">
				<input placeholder="填写具体详细地址" style="right:30px;" ref="areaInput" />
			</div>
		</div>
		<div class="list">
			<p>职业</p>
			<div class="list-right">
				<input placeholder="选择/编辑职业" ref="occupationInput" />
				<div class="selectDiv">
					<img src="@/assets/images/icon/mineHore.png" />
				</div>
			</div>
		...
		<div class="list">
			<p>邮箱</p>
			<div class="list-right">
				<input placeholder="填写您的邮箱" ref="email" />
				<div class="selectDiv">
					<img src="@/assets/images/icon/mineHore.png" />
				</div>
			</div>
