...
<div class="all">
  ...
  <div class="doctorList" v-for="(item,key,index) in dataList" :key="key">
    <div class="box">
      ...
      <div class="boxBottom" v-if="item.coverResource!=null && isId!=1">
        <img :src="item.coverResource.cover || ImgNull" />
        <div v-if="item.coverResource.isVideo==1" class="playImg" @click="isIdFun(item.coverResource.url)">
          <img src="@/assets/images/icon/playImg.png" />
        </div>
      </div>
      <Samll-Video class="boxBottom" @surt="surt" v-if="isId==1" :videoUrl="videoUrl"></Samll-Video>
