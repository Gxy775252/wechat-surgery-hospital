		...
		<div class="diaryList">
			...
			<div class="list">
				...
				<div class="list-right">
					<input placeholder="填写项目名称" type="text" v-model='proName' />
					<div class="right-div ">
						<!-- <img src="@/assets/images/icon/mineHore.png" /> -->
					</div>
				</div>
			...
			<div class="list">
				<p>项目天数</p>
				<div class="list-right">
					<input placeholder="填写项目天数" type="number" v-model='proNumber' />
					<div class="right-div ">
						<!-- <img src="@/assets/images/icon/mineHore.png" /> -->
					</div>
				</div>
			...
			<div class="question">
				...
				<div class="question-textarea">
					<wv-textarea placeholder="请输入文本" :rows="4" :show-counter="false" v-model='conName'></wv-textarea>
				</div>
			</div>
			<div class="img">
